...
class Trainer(object):
    ...
    def build_model(self):
        ...
        if self.ckpt is not None:
            self.c3d.load_state_dict(torch.load(self.ckpt))

        print(self.c3d)

    def train(self):
        # define optimizer
        opt = optim.Adam(filter(lambda p: p.requires_grad, self.c3d.parameters()),
        ...
        for epoch in range(self.n_epochs):
            ...
            try:
                for step, (h, r) in enumerate(zip(self.h_loader, self.r_loader)):
                    ...
                    # forward
                    predicted = self.c3d(h_video.cuda())  # predicted snippet's score
                    ...
                    # forward
                    predicted = self.c3d(r_video.cuda())  # predicted snippet's score
                    target = torch.from_numpy(
            ...
            # keyboard interrupt routine => save checkpoint file & hyper parameters
                ...
                torch.save(self.c3d.state_dict(),
            ...
            if epoch % self.checkpoint_step == 0:
                ...
                torch.save(self.c3d.state_dict(), '../checkpoints/epoch' + str(epoch) + '_' + s + '.pth')
