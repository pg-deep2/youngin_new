...
#         optimizer.zero_grad()
#         print(images.shape) # [20, 3, 299, 299]
#         outputs = cnn(images)
#
...
#             vis.plot("Loss plot", loss.data[0])
...
#     vis.plot("Test Accuracy plot:", 100 * correct / total)
#
# print(outputs)
# # # Save the Trained Model
# torch.save(cnn.state_dict(), 'final_cnn.pkl')
#
# # Test
# final_model = torch.load('final_cnn.pkl')
# # Test accuracy
# final_model.eval()
# test_avg_acc = 0.
# test_cnt = 0
...
#     predicted = final_model(video)  # [ frame 수, 1]
#
